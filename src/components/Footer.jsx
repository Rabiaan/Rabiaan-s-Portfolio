    ...
    <footer className="bg-brand-black text-white py-20 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="text-center md:text-left">
          <h3 className="text-3xl font-display font-black tracking-tighter mb-2 uppercase">Syed <span className="text-brand-blue">Rabiaan</span></h3>
          <p className="text-gray-400 text-sm max-w-xs">Front-End & CMS Developer & Creative Enthusiast based in Karachi, Pakistan.</p>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] uppercase tracking-widest text-gray-500">
        <p>© {new Date().getFullYear()} Syed Rabiaan Zafar. All Rights Reserved.</p>
